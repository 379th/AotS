    ...
    <ScreenFrame>
      ...
      <div className={`mx-auto mt-3 w-[521px] h-[782px] rounded-2xl border p-4 transition-colors duration-300 ${
        ...
        <div className={`h-full w-full overflow-auto rounded-xl border p-4 leading-relaxed space-y-4 transition-colors duration-300 ${
          ...
          <h3 className="mt-4 text-[27px] font-bold">{t.aboutQuest.whyDoQuest}</h3>
          <p className="mt-2 text-[17px]">
            {t.aboutQuest.whyDoQuestDescription}
          </p>
          
          <h3 className="mt-4 text-[27px] font-bold">{t.aboutQuest.whatYouGet}</h3>
          <ul className="mt-2 list-disc pl-5 space-y-1 text-[17px]">
            {t.aboutQuest.whatYouGetList.map((item, index) => (
              <li key={index}>{item}</li>
            ))}
          </ul>
          
          <h3 className="mt-4 text-[27px] font-bold">{t.aboutQuest.howItGoes}</h3>
          <ul className="mt-2 list-disc pl-5 space-y-1 text-[17px]">
          ...
          <h3 className="mt-4 text-[27px] font-bold">{t.aboutQuest.whoIsFor}</h3>
          <ul className="mt-2 list-disc pl-5 space-y-1 text-[17px]">
          ...
          <h3 className="mt-4 text-[27px] font-bold">{t.aboutQuest.whatYouNeed}</h3>
          <p className="mt-2 text-[17px]">
