      ...
      <div className="flex flex-col h-full overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="mx-auto mt-4 w-full max-w-[90vw] sm:max-w-[521px] px-2 sm:px-4">
            ...
            <div className="flex flex-row sm:flex-row sm:justify-between gap-1 sm:gap-3 justify-center items-center">
              <button onClick={onAboutCreator} className="w-full max-w-[120px] sm:w-[158px] h-[60px] sm:h-[80px] transition-transform active:scale-95 hover:scale-105">
                <img src={getImageUrl(EXTERNAL_ASSETS.BUTTONS.ABOUT_CREATOR)} alt={t.intro.aboutCreator} className="w-full h-full object-cover" />
              </button>
              <button onClick={onStart} className="w-full max-w-[120px] sm:w-[158px] h-[60px] sm:h-[80px] transition-transform active:scale-95 hover:scale-105">
                <img src={getImageUrl(EXTERNAL_ASSETS.BUTTONS.START)} alt={t.intro.start} className="w-full h-full object-cover" />
              </button>
              <button onClick={onAboutQuest} className="w-full max-w-[120px] sm:w-[158px] h-[60px] sm:h-[80px] transition-transform active:scale-95 hover:scale-105">
            ...
            <div className="flex flex-row sm:hidden gap-1 justify-center items-center mt-2">
              <button onClick={onOpenFaq} className="w-full max-w-[120px] h-[60px] transition-transform active:scale-95 hover:scale-105">
                <img src={getImageUrl(EXTERNAL_ASSETS.BUTTONS.FAQ)} alt={t.intro.faq} className="w-full h-full object-cover" />
              </button>
              <button onClick={onOpenSettings} className="w-full max-w-[120px] h-[60px] transition-transform active:scale-95 hover:scale-105">
