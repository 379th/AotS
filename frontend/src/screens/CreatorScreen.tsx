  ...
  return (
    <ScreenFrame>
      ...
      <div className={`mx-auto mt-3 w-[521px] h-[782px] rounded-2xl border p-4 transition-colors duration-300 ${
        ...
        <h3 className="text-[27px] font-bold">{t.creator.acknowledgments}</h3>
        <div className="h-full mt-2 space-y-2 text-[17px] leading-relaxed overflow-y-auto">
      ...
      <div className={`mx-auto mt-3 w-[521px] h-[782px] rounded-2xl border p-4 transition-colors duration-300 ${
        ...
        <div className={`w-full h-full rounded-xl border p-4 leading-relaxed transition-colors duration-300 ${
          theme === 'dark' 
