      ...
      <div className="mx-auto mt-2 w-[92%] rounded-2xl border border-amber-900/40 bg-input-gradient p-4 text-amber-900">
        <div className="w-full rounded-xl border border-amber-900/30 bg-white/70 p-4 leading-relaxed">
          <p className="mt-2 text-[14px] md:text-[15px]">
            ...
            Он соединяет игру и познание: от индийской традиции и «Лилы» до Юнга и современной психологии. 
            Пишет и снимает, исследует человечество как социолог, учится у жизни как ученик, 
            работает с архетипами как игропрактик, мыслит как философ, дышит и дисциплинируется как йогин, 
            путешествует взглядом фотографа, а в цифровом мире держит осознанность как кибер‑монах.
          </p>
        </div>
      </div>
