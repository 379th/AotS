...
export const RequestScreen: React.FC<RequestScreenProps> = ({
  ...
  return (
    <ScreenFrame>
      ...
      {/* Основной контентный блок от верхнего Запрос до нижнего поля запроса */}
      <div className="absolute top-0 left-0 right-0 z-10 px-4 pt-20 pb-4 max-w-[520px] mx-auto">
