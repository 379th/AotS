          ...
          <div className="flex-1 min-h-0">
            <div className={`text-[27px] font-medium mb-3 transition-colors duration-300 ${
              theme === 'dark' ? 'text-white' : 'text-amber-900'
                ...
                {!hasCurrentPair ? (
                  <div className={`w-full h-32 px-4 py-3 text-[27px] border rounded-lg flex items-center justify-center transition-colors duration-300 ${
                    theme === 'dark' 
                  ...
                  <div className={`rounded-xl border p-4 space-y-4 transition-colors duration-300 ${
                    ...
                    <div className="text-center">
                      ...
                      <p className={`text-[27px] transition-colors duration-300 ${
                    ...
                    {archetypeData.conflict_or_resource && (
                      <div>
                        <h4 className={`text-[27px] font-semibold mb-2 transition-colors duration-300 ${
                          theme === 'dark' ? 'text-white' : 'text-amber-900'
                        }`}>
                          Ресурс
                        </h4>
