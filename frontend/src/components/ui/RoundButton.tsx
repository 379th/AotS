...
export const RoundButton: React.FC<RoundButtonProps> = ({ 
  ...
  return (
    <button 
      onClick={onClick}
      className={`group relative flex h-16 w-16 md:h-20 md:w-20 flex-col items-center justify-center rounded-full bg-gradient-to-b ${TONE_MAP[tone]} ring-2 text-amber-100 shadow-[0_8px_30px_rgba(0,0,0,.35)] transition-transform active:scale-95 hover:scale-105`}
    >
