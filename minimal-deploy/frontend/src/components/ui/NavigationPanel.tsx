...
export const NavigationPanel: React.FC<NavigationPanelProps> = ({
  ...
  return (
    <div className="mx-auto w-full max-w-[520px]">
      <div 
        className="rounded-2xl border border-amber-900/40 p-3 py-4 shadow-[0_8px_30px_rgba(0,0,0,.35)] min-h-[100px]"
        style={{
          backgroundImage: 'url(/Sorce/navigation_panel/back_navigation_panel.png)',
      ...
      >
                      ...
                      />
                      <RoundButton 
                        label={t.navigation.deck} 
                        imageSrc="/Sorce/navigation_panel/04_Deck.png" 
                        tone="sky" 
                        onClick={onOpenDeck} 
                      />
                      <RoundButton 
                        label={t.navigation.exit} 
